...
function testCreateMenuItem() {
  ...
  assert.strictEqual(
    menuItem.id,
    exampleItem.id,
    "id should equal exampleItem.id",
  );
  assert.strictEqual(
    menuItem.name,
    exampleItem.name,
    "name should equal exampleItem.name",
  );
  assert.strictEqual(
    menuItem.price,
    exampleItem.price,
    "price should equal exampleItem.price",
  );
  assert.strictEqual(
    menuItem.allergen,
    exampleItem.allergen,
    "allergen should equal exampleItem.allergen",
  );
  assert.strictEqual(
    menuItem.description,
    exampleItem.description,
    "description should equal exampleItem.description",
  );
}
...
function testCreateOrder() {
  ...
  assert.strictEqual(
    order.id,
    exampleOrder.id,
    "id should equal exampleOrder.id",
  );
  assert.strictEqual(
    order.accountId,
    exampleOrder.accountId,
    "accountId should equal exampleOrder.accountId",
  );
  assert.strictEqual(
    order.orderTime,
    exampleOrder.orderTime,
    "orderTime should equal exampleOrder.orderTime",
  );
  assert.strictEqual(
    order.pickupLocation,
    exampleOrder.pickupLocation,
    "pickupLocation should equal exampleOrder.pickupLocation",
  );
  assert.strictEqual(
    order.items,
    exampleOrder.items,
    "items should equal exampleOrder.items",
  );
  assert.strictEqual(
    order.costOfItems,
    exampleOrder.costOfItems,
    "costOfItems should equal exampleOrder.costOfItems",
  );
  assert.strictEqual(
    order.tip,
    exampleOrder.tip,
    "tip should equal exampleOrder.tip",
  );
  assert.strictEqual(
    order.completed,
    exampleOrder.completed,
    "completed should equal exampleOrder.completed",
  );
}
...
function testCreateAccount() {
  ...
  assert.strictEqual(
    account.id,
    exampleAccount.id,
    "id should equal exampleAccount.id",
  );
  assert.strictEqual(
    account.name,
    exampleAccount.name,
    "name should equal exampleAccount.name",
  );
  assert.strictEqual(
    account.email,
    exampleAccount.email,
    "email should equal exampleAccount.email",
  );
  assert.strictEqual(
    account.phone,
    exampleAccount.phone,
    "phone should equal exampleAccount.phone",
  );
  assert.strictEqual(
    account.accessLevel,
    exampleAccount.accessLevel,
    "accessLevel should equal exampleAccount.accessLevel",
  );
  assert.strictEqual(
    account.cart,
    exampleAccount.cart,
    "cart should equal exampleAccount.cart",
  );
}
...
function testCreatePickupLocation() {
  ...
  assert.strictEqual(
    location.id,
    exampleLocation.id,
    "id should equal exampleLocation.id",
  );
  assert.strictEqual(
    location.address,
    exampleLocation.address,
    "address should equal exampleLocation.address",
  );
  assert.strictEqual(
    location.contactInfo,
    exampleLocation.contactInfo,
    "contactInfo should equal exampleLocation.contactInfo",
  );
  assert.strictEqual(
    location.name,
    exampleLocation.name,
    "name should equal exampleLocation.name",
  );
}
